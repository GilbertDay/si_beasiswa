<x-app-layout>
    <div class="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-xs rounded-xl m-4">
        <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
            <h2 class="font-semibold text-gray-800 dark:text-gray-100">Pengumuman Beasiswa</h2>
        </header>
        <div class="p-3">
                ...
                <table class="table-fixed w-full dark:text-gray-300">
                    ...
                    <tbody class="text-sm font-medium divide-y divide-gray-100 dark:divide-gray-700/60">
                        ...
                        <tr>
                            ...
                            <td class="p-2 w-1/4">
                                <div class="text-start text-gray-500">72200011</div>
                            </td>
                        </tr>
                        <!-- Row -->
                        <tr>
                            ...
                            <td class="p-2 w-1/4">
                                <div class="text-start text-gray-500">Beasiswa Akademik</div>
                            </td>
                        </tr>
                        <!-- Row -->
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="p-2 w-1/4">
                                <div class="text-start text-gray-500">Diterima</div>
                            </td>
                        </tr>
                         <!-- Row -->
                         <tr>
                            ...
                            <td class="p-2 w-1/4">
                                <div class="text-start text-gray-500">10 Maret 2025</div>
                            </td>
                        </tr>
                         <!-- Row -->
                         <tr>
                            ...
                            <td class="p-2 w-1/4">
                                <div class="text-start text-gray-500">Selamat! Anda telah diterima sebagai penerima Beasiswa Akademik untuk periode 2025/2026.
                                    Silakan cek detail pencairan dana dan syarat selanjutnya.</div>
                            </td>
                        </tr>
                         <!-- Row opsi -->
                         {{-- <tr>
